                ...
                <div className="content-wrapper">
                    ...
                    <span className="input-group-append">
                      ...
                      <i className="fas fa-ellipsis-v"></i>
                                                    ...
                                                    <small className="badge badge-danger"><i
                                                        className="far fa-clock"></i> 2 mins</small>
                    ...
                    <span className="handle">
                      ...
                      <i className="fas fa-ellipsis-v"></i>
                                                    ...
                                                    <small className="badge badge-info"><i
                                                        className="far fa-clock"></i> 4 hours</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"></i>
                                                        <i className="fas fa-trash-o"></i>
                                                    </div>
                    ...
                    <span className="handle">
                      ...
                      <i className="fas fa-ellipsis-v"></i>
                                                    ...
                                                    <small className="badge badge-warning"><i
                                                        className="far fa-clock"></i> 1 day</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"></i>
                                                        <i className="fas fa-trash-o"></i>
                                                    </div>
                    ...
                    <span className="handle">
                      ...
                      <i className="fas fa-ellipsis-v"></i>
                                                    ...
                                                    <small className="badge badge-success"><i
                                                        className="far fa-clock"></i> 3 days</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"></i>
                                                        <i className="fas fa-trash-o"></i>
                                                    </div>
                    ...
                    <span className="handle">
                      ...
                      <i className="fas fa-ellipsis-v"></i>
                                                    ...
                                                    <small className="badge badge-primary"><i
                                                        className="far fa-clock"></i> 1 week</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"></i>
                                                        <i className="fas fa-trash-o"></i>
                                                    </div>
                    ...
                    <span className="handle">
                      ...
                      <i className="fas fa-ellipsis-v"></i>
                                                    ...
                                                    <small className="badge badge-secondary"><i
                                                        className="far fa-clock"></i> 1 month</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"></i>
                                                        <i className="fas fa-trash-o"></i>
                                                    </div>
                                        ...
                                        <div className="card-footer clearfix">
                                            <button type="button" className="btn btn-info float-right"><i
                                                className="fas fa-plus"></i> Add item
                                            </button>
                                        </div>
                                    </div>
